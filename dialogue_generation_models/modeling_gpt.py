...
"""
HuggingFace의 GPT 모델 코드를 바탕으로 일부 재작성한 Pingpong GPT 모델 코드입니다.
원코드: https://github.com/huggingface/transformers/blob/master/src/transformers/modeling_gpt2.py
"""
...
from .configuration_gpt import GPT2Config
...
class Block(nn.Module):
    ...
    def forward(
        ...
        # residual connection
        hidden_states = self.ln_1(attn_output + hidden_states)
        ...
        # residual connection
        hidden_states = self.ln_2(hidden_states + feed_forward_hidden_states)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if inputs_embeds is None:
            inputs_embeds = self.wte(input_ids) * (self.n_embd ** 0.5)
